...
=======
    "별똥별의": "SenshoSensho_star"  # 센쇼 각인 전용
...
def _make_description(stats, special=None):
    ...
    effect_desc = {
        ...
        "earthreg_faith": "🙏 **[믿음]** 첫 합에서 방어 사용 시, 턴 종료 후 해당 턴 총 방어값의 25%만큼 체력/정신력 회복",
<<<<<<< HEAD
        "Sensho_star": "🌠 **[별똥별]** '별의 은총' 사용 시 12.5% 확률로 체력 완전 회복 (단, 방어 효과 소멸)"
=======
        "SenshoSensho_star": "🌠 **[별똥별]** '별의 은총' 사용 시 12.5% 확률로 체력 완전 회복 (단, 방어 효과 소멸)"
>>>>>>> 3c9447088ff0b78f3f0d009b3f179822aea6e5e4
    }
