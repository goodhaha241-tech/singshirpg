...
ARTIFACT_EFFECT_WIKI = {
    ...
    "Sensho_star": ("별똥별의", "센쇼의 별의 은총에 특별한 강화 판정을 추가합니다."),
    "kaian_time": ("시간의", "시간가속이 7스택까지 누적되어 스택당 주사위 위력이 25% 증가하고, 만충 시 회복과 최대 체력 비례 피해를 발동합니다."),
    "shayla_light": ("빛나는", "샤일라의 밀키워킹에 적 행동 파괴 효과를 추가합니다."),
    "yeongseol_severe_cold": (
        "혹한",
        "영설의 공격 주사위로 서리를 쌓습니다. 3스택마다 피격 대상에게 빙결 5턴을 부여하고 빙결 대상에게 준 실제 HP 피해의 20%를 회복합니다.",
    ),
}
